...
if(!isset($_GET['video_id'])||$_GET['video_id']==''){
	http_response_code(400);
	die('missing video_id');
}

$redirect_uri = 'https://dev.twitch.tv/docs/api/reference#get-stream-markers';
$redirect_uri = '';
$redirect_uri .= '';
$redirect_uri .= 'https://api.twitch.tv/helix/streams/markers';
$redirect_uri .= '?video_id='.$_GET['video_id'];
